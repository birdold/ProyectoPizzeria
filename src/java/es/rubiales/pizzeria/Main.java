...
import es.rubiales.pizzeria.bd.PizzeriaDBManagerMySQL;
...
public class Main extends HttpServlet {
    ...
    private static final Logger logger = Logger.getLogger(PizzeriaDBManagerMySQL.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PizzeriaDBManagerMySQL.connect(dbServer, dbName, dbUser, dbPassword);

        //Comprueba si se ha podido realizar la conexión
        if (PizzeriaDBManagerMySQL.isConnected()) {
            ...
            if (action != null && !action.isEmpty()) {
                ...
                if (action.equals(ACTION_EDIT_REQUEST)) {
                    ...
                    Pizzeria pizzeria = PizzeriaDBManagerMySQL.getPizzeriaByID(id);
                    ...
                    redirectTo("pizzeria_detail.jsp", request, response);
                    ...
                    updateCatalogoWithRequestData(pizzeria, request);
                    //Se actualiza en la BD la persona
                    PizzeriaDBManagerMySQL.updatePizzeria(pizzeria);
                    ...
                    Pizzeria pizzeria = new Pizzeria();
                    updateCatalogoWithRequestData(pizzeria, request);
                    PizzeriaDBManagerMySQL.insertPizzeria(pizzeria);
                    response.sendRedirect("Main?action=");
                    ...
                    PizzeriaDBManagerMySQL.deletePizzeriaById(id);
                    response.sendRedirect("Main?action=");
                    ...
                    ArrayList<Pizzeria> pizzeriaList = PizzeriaDBManagerMySQL.getPizzeriaList();
                ...
                ArrayList<Pizzeria> pizzeriaList = PizzeriaDBManagerMySQL.getPizzeriaList();
                request.setAttribute("pizzeriaList", pizzeriaList);
                redirectTo("pizzeria_list.jsp", request, response);
            }
     ...
     * @param request
     */
    private void updateCatalogoWithRequestData(Pizzeria pizzeria, HttpServletRequest request) {
        pizzeria.setName(request.getParameter("name"));
        pizzeria.setPrice(request.getParameter("price"));
        pizzeria.setComments(request.getParameter("comments"));
        ...
        if(request.getParameter("deletePhoto")!=null && request.getParameter("deletePhoto").equals("on")) {
            ...
            if(!pizzeria.getPhotoFileName().isEmpty() && pizzeria.getPhotoFileName()!=null) {
                deletePhotoFile(request, pizzeria.getPhotoFileName());
                pizzeria.setPhotoFileName("");
            }
            ...
            if(photoFileName!=null) {
                if(pizzeria.getPhotoFileName().isEmpty() || pizzeria.getPhotoFileName()==null) {
                    ...
                    pizzeria.setPhotoFileName(photoFileName);
                } else {
